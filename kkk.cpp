//----------------------------------------------------------------------------------------------------------------------------
//
//                                        TrajectSim V1.02  -  !!  For SRP maneuver only !!
//
...
//--------------------------------------------------------------
    ...
    char file_cinitial[50]= "INPUT/c_initial_thrust.dat";
...
double S = load_cship(0) / ( 1.5 * load_cship(1));
//---------------------------------------------------------------------------------------------------------------------------
...
//.................................................................
    cout << t << '\t' << x[0] << '\t' << x[1] << '\t' << x[2]-rm << '\t' << x[3] << '\t' << x[4] << '\t' << x[5] <<  '\t' << rho << '\t' << D << '\t' << L << '\t' << Ty << '\t' << gr << '\t' << gn << '\t' << g << '\t' << T << '\t' <<Ma << '\t' << gamma << '\t' << R << '\t' << P << '\t' << Cd << '\t' << Cl << '\t' << heating << '\t' << flowzone << '\t' << qinf << '\t' << CdPar <<  '\t' << Thrust << '\t' << CdC << '\t' << bank << '\t' << acc << '\t' << m << '\t' << event << '\t' << BC << '\t' << X_horizontal << endl;
}
//----------------------------------------------------------------------------------------------------------------------------
//
//                                                     Integrator
...
double t1   = T1; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //40; //load_cinteg(1);                 // End time   [s]
double step = step_size;                // Step time  [s]
int i;
double init[6];
for(i=0;i<6;i++)
{
