...
//cout << M0 << '\t' << M_payload << '\t' << M_shield << '\t' << M_structure << '\t' << M_rcs << '\t' << M_tds << endl;
//
double mfuel_cor = 0.9;
//----------------------------------------------------------------------------------------------------------------------------
#include <iostream>
#include <fstream>
#include <cmath>
...
//---------------------------------------------------------------------------------------------------------------------------
double Mfuel = load_from_file(3, lines_interim, file_interim) * mfuel_cor;
...
//-----------------------------------------------------------------------------------------------------
double mf_shield = Phi_shield / ( BC * Cd );
double M_shield = mf_shield * M0;
double M_structure = (f_structure + f_backshell ) * M0;
double M_rcs = (f_eng_rcs + f_prop_rcs ) * M0;
double M_tds = M_Indep;  
//----------------------------------------------------------------------------------------------------------------------------
cout << M0 << '\t' << M_payload << '\t' << M_shield << '\t' << M_structure << '\t' << M_rcs << '\t' << M_tds << endl;
}
